...
<template>
    ...
    <MainLayout>
            ...
            <div class="flex items-center md:justify-between">
                ...
                <div class=" ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        ...
                        <Cog class=" cursor-pointer" :size="28" />
                    ...
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            ...
                            <div class="mr-6">
                                <span class=" font-extrabold">14</span> followers
                            </div>
                            <div class="mr-6">
                                <span class=" font-extrabold">400</span> following
                            </div>
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                <div class="text-center p-3">
                    <div class=" font-extralight">{{ postsByUser.data.length }}</div>
                    <div class=" text-gray-400 font-semibold -mt-1.5">posts</div>
                </div>
                <div class="text-center p-3">
                    <div class=" font-extralight">40</div>
                    <div class=" text-gray-400 font-semibold -mt-1.5">followers</div>
                </div>
                <div class="text-center p-3">
                    <div class=" font-extralight">400</div>
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-0 md:pl-[90px]">
            ...
            <div class="grid md:gap-4 gap-1 grid-cols-3 relative">
                <div v-for="postsByUser in postsByUser.data" :key="postsByUser ">
                    <ContentOverlay :postsByUser="postsByUser" @selectedPost="data.post=$event"/>
                </div>
            </div>
            <div class="pb-20">
    ...
    <ShowPostOverlay v-if="data.post" :post="data.post" @addComment="addComment($event)"
        @updateLike="updateLike($event)" @deleteSelected="deleteFunc($event)" @closeOverlay="data.post = null" />
</template>
