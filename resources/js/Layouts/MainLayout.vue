...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        <div v-if="$page.url !== '/'" id="TopNavUser"
            class="md:hidden fixed flex items-center justify-between z-30 w-full bg-white border-b border-b-gray-300">
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            ...
            <div class="px-3">
                ...
                <MenuItem @click="$event => showCreatedPost = true" iconString="Create" class="mb-4" />
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSection" class="lg:w-4/12 lg:block hidden text-black mt-10">
                ...
                <div class="flex items-center">
                    <img class="rounded-full z-20 w-[58px] h-[58px]" :src="$page.props.auth.user.file" />
                    <div class="pl-4">
                ...
                <div v-for="randUser in $page.props.randomUsers" :key="randUser">
                    <Link :href="route('users.show', {id: randUser.id})" class="flex items-center justify-between max-w-[300px] pb-2">
                        <template v-if="randUser.id !== $page.props.auth.user.id">
                            <div class="flex items-center">
                                <img class="rounded-full z-20 w-[37px] h-[37px]" :src="randUser.file" />
                                <div class="pl-4">
                                    <div class="text-black font-extrabold">
                                        {{ randUser.name }}
                                    </div>
        ...
        <div id="BottomNav"
            class="fixed z-30 bottom-0 w-full md:hidden flex items-center justify-around bg-white border-t border-t-gray-300">
            <Link href="/">
            ...
            <Plus @click="$event => showCreatedPost = true" fillColor="#000000" :size="33" class="cursor-pointer" />
    ...
    <CreatePostOverlay v-if="showCreatedPost" @close="$event => showCreatedPost = false" />
</template>
